...
pub const motion_notify_event_t = extern struct {
    response_type: u8,
    detail: u8,
    sequence: u16,
    time: timestamp_t,
...
pub const button_press_event_t = extern struct {
    response_type: u8,
    detail: button_t,
    sequence: u16,
    time: timestamp_t,
...
pub const button_release_event_t = extern struct {
    response_type: u8,
    detail: button_t,
    sequence: u16,
    time: timestamp_t,
...
pub const MOD_MASK = packed struct(u16) {
    MOD_SHIFT: bool,
    MOD_LOCK: bool,
    MOD_CONTROL: bool,
    MOD_1: bool,
